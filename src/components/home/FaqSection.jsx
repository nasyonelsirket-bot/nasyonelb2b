            ...
            return (
              <li key={item.q}>
                <button
                  ...
                  className="w-full flex items-center gap-3 text-left px-4 py-4 hover:bg-gray-50 transition"
                >
                  <ChevronRight
                ...
                {isOpen && (
                  <div className="px-4 pb-4 pl-11 text-sm text-gray-600 leading-relaxed bg-gray-50/80">
                    {item.a}
                  </div>
                )}
              </li>
